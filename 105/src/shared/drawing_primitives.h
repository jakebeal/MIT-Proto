...
extern void draw_text (flo w, flo h, char *txt);
extern void draw_text_justified (TXT_DIR td, flo w, flo h, char *txt);
extern void draw_text_raw (TXT_DIR td, flo w, flo h, char *txt);
extern void draw_text_halo (flo w, flo h, char *txt);
extern void draw_text_block (TXT_DIR td, flo w, flo h, char *txt);
extern void draw_text_block_fuzz (TXT_DIR td, flo s, int n, flo w, flo h, char *txt);
